...
/**
 * Create server
 * - Create server method takes callback function which will get
 *  executed everytime when any request try to access our server
 */
const server = http.createServer((req, res) => {
    ...
    if (pathName === '/products' || pathName === '/') {
        ...
        fs.readFile(`${__dirname}/data/templates/template-overview.html`, 'utf-8', (err, data) => {
            ...
            fs.readFile(`${__dirname}/data/templates/template-card.html`,'utf-8', (err, data) => {
                const cardsOutput = jsonData.map(el => replaceTemplate(data, el)).join('');
    ...
    // IMAGES
        ...
        res.end("Reqeusted page not found");
    } 
});
